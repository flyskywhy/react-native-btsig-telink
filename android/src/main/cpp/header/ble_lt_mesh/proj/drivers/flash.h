...
/*_attribute_ram_code_ */void flash_write_page(u32 addr, u32 len, const u8 *buf);
...
enum{
	FLASH_ID_GD25Q40 = 0xc840,
	FLASH_ID_GD25LD40 = 0xc860,
	FLASH_ID_MD25D40 = 0x5140,
	FLASH_ID_GD25D10 = 0x1c31,
};
