...
public class TemperatureMessage implements ModelMessage {
    ...
    public static TemperatureMessage createInstance(int temperature) {
        TemperatureMessage instance = new TemperatureMessage();
    ...
    @Override
    public byte[] toBytes() {
        return new byte[]{(byte) (this.temperature), (byte) ((this.temperature >> 8)),
                (byte) (this.deltaUV), (byte) ((this.deltaUV >> 8)),
