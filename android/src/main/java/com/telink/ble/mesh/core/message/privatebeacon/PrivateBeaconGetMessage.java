/********************************************************************************************************
 * @file PrivateBeaconGetMessage.java
 *
...
/**
 * A PRIVATE_BEACON_GET message is an acknowledged message used to get the current Private Beacon state
 * and Random Update Interval Steps state of a node.
 */
